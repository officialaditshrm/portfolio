            ...
            <div id = "contactcontent" className = "flex max-sm:flex-col pb-10">
                ...
                <div id = "messageui" className = "font-gugi flex-1 flex-col px-3 items-center justify-center">
                    <fieldset className = "border-2 px-10 py-5 border-black dark:border-amber-100 rounded-xl flex flex-col justify-center dark:text-white items-center">
                        ...
                        <form className = "flex flex-col gap-6 max-sm:gap-4 text-center w-full" onClick = {submit} >
                            <div className = "w-full flex flex-1 justify-center gap-3 items-center">
                                <label>Name:</label><input type="text" className = "dark:bg-neutral-900/70 bg-neutral-200/70 max-sm:text-[3.6vw] max-sm:w-[48vw] w-[20vw] h-[7vh] p-2 text-[3vh] rounded-md border border-neutral-900 dark:border-neutral-500 "/>
                            </div>
                            <div className = "w-full flex flex-1 justify-center gap-3 items-center">
                                <label>Organization:</label><input type = "text" className = "dark:bg-neutral-900/70 bg-neutral-200/70 max-sm:text-[3.6vw] max-sm:w-[48vw] w-[20vw] h-[7vh] p-2 text-[3vh] rounded-md border border-neutral-900 dark:border-neutral-500"/>
                            </div>
                            <div className = "w-full flex flex-1 justify-center gap-3 items-center">
                                <label>Contact:</label><input className = "dark:bg-neutral-900/70 bg-neutral-200/70 max-sm:text-[3.6vw] max-sm:w-[48vw] w-[20vw] h-[7vh] p-2 text-[3vh] rounded-md border border-neutral-900 dark:border-neutral-500" type = "text" id = "contactinput"/>
                            </div>
                            <div className = "w-full flex flex-col items-center justify-center">
                                <label>Message:</label><textarea className = "p-2 bg-neutral-200/70 dark:bg-neutral-900/70 max-sm:text-[3.6vw] m-8 rounded-md border w-full border-neutral-900 dark:border-neutral-500 h-[20vh]" id = "messageinput"/>
                            </div>
                            <div>
