...
import mdjiki from "../images/mdjiki.png"
...
const projectlist = [
    {
        ...
        img: mdjiki,
        description: "A Markdown-powered wiki-style encyclopedia for users. Supported creation/editing of over 50 test entries with robust Markdown-to-HTML conversion. Implemented search and error handling that reduced user navigation errors by 60%. Used Django's template engine and CSRF protection to achieve 100% form submission security in testing",
        techstack: ["Django",
                        "Python",
                        "HTML",
                        "CSS",
