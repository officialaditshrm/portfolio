        ...
        <div id = "projects" className = "font-gugi flex flex-col bg-sky-200 dark:bg-zinc-900 dark:text-white text-center">
            ...
            <div id = "project" className = "flex">
                <div id = "projectflash" className = "flex-1 flex flex-col">
                    <div id = "projectshow" className = "flex-1 flex justify-center items-center">
                        <img src = {project} className = "w-full h-full object-cover"/>
                    </div>
                ...
                <div id = "projectcontent" className = "flex-1 flex flex-col">
                    <div id = "projectbuttons" className = "flex justify-evenly items-center text-white dark:text-black py-12">
                        <button className = "rounded-md hover:translate-x-[8px] hover:translate-y-[4px] dark:hover:shadow-[-8px_-4px_5px_0_rgba(255,255,255,0.3)] hover:shadow-[-8px_-4px_5px_0_rgba(0,0,0,0.3)] duration-300 py-5 px-10 bg-neutral-800 dark:bg-neutral-300">Github</button>
                        <button className = "rounded-md hover:translate-x-[8px] hover:translate-y-[4px] dark:hover:shadow-[-8px_-4px_5px_0_rgba(255,255,255,0.3)] hover:shadow-[-8px_-4px_5px_0_rgba(0,0,0,0.3)] duration-300 py-5 px-10 bg-neutral-800 dark:bg-neutral-300">Deployment</button>
                    </div>
                    <div id = "projectdesc" className = "p-16 max-sm:p-8 font-gruppo text-[1.5vw]">
                        <p>
